import './Footer.css'
import logo from '../../assets/logo-bookmark-dark.svg';
...
export default function Footer(){
    return (
        <footer>
            ...
            <nav>
                <TabLink to='/features' className='dark'>FEATURES</TabLink>
                <TabLink to='/pricing' className='dark'>PRICING</TabLink>
                <TabLink to='/contact' className='dark'>CONTACT</TabLink>
            </nav>
