    ...
    return (
        <header className="mobile" data-active={active}>
            <div className="min">
                ...
                <button onClick={() => setActive(current => !current)}>
                    <img src={active ? closeicon : hamburgericon} alt="Navigation-bar toggle" />
                </button>
            </div>
            <nav>
                <TabLink to='/features'>FEATURES</TabLink>
